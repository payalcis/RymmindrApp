...
function Bookings (props) {
  ...
  const [bookedSlotDetails, setBookedSlotDetails] = useState({id: null, event_id: null, meeting_id: null, personName: null});
                ...
                <BoxStyled alignItems='center'>
                  ...
                  <Typography noWrap>
                    <Box fontWeight='fontWeightBold' m={1}>
                        { ( bookingDetails != null ) ? bookingDetails.category: null } | { ( bookingDetails != null ) ? bookingDetails.subject: null }
                    </Box>
                  </Typography>
                </BoxStyled>
              </Grid>
                                ...
                                userStatus.slots.map((slot, slotIndex) => {
                                    return (
                                        <Grid className="table-wrap" item xs={4} key={slotIndex}>
                                            <TypoContentStyled className="table-head">{slot.day} {slot.date}</TypoContentStyled>
