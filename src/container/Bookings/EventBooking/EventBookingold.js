...
*/
  ...
  const handleToSubmit = () => {
    console.log(
      'handleToSubmithandleToSubmithandleToSubmithandleToSubmithandleToSubmithandleToSubmithandleToSubmithandleToSubmit'
    );
    if (validate()) return false;
    if (dynamicValidate()) return false;

    console.log('dynamicValidate');
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    updateEventbook: (data, unmatch, history, sendAttachment) =>
      dispatch(updateEventbook(data, unmatch, history, sendAttachment)),
