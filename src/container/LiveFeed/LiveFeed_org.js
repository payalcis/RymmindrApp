      ...
      <Grid container alignItems='stretch'>
        ...
        <Grid item xs={12} md={8} className={classes.rightPanel} style={{ display: showPanel ? 'none' : 'block' }}>
          <Paper className={classes.paper}>
            ...
            <TypoStyled>
              <img src={require('../../assets/images/image.png')} className={classes.feedImg} />
              <img src={require('../../assets/images/feed_image.png')} style={{ height: 20 }} />
              <Box style={{ fontSize: 14, marginBottom: 20 }}>Wednesday 1 April 2020</Box>
